    ...
    <body>
        ...
        <aside class="w-0 md:w-2/5 lg:w-[400px] h-screen bg-gray-900 flex flex-col">
            ...
            <ul class="flex flex-col items-center space-y-3 mt-5 mx-3 flex-1">
                ...
                <a href="{{ route('eventCreate') }}" class="w-[95%] flex items-center gap-3 cursor-pointer rounded-md py-2 pl-5 text-white hover:bg-gray-700">
                    {{-- <li
                        class=""> --}}
                        <!-- Team Icon -->
                        <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p class="text-lg font-bold tracking-wider">Create Event</p>
                    {{-- </li> --}}
                </a>
