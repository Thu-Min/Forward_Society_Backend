...
<div class="w-[80%] h-max  mx-auto ">
    <div class="mt-5 md:mt-0 ">
      <form action="{{route('testimonial.update',$testimonialDBData['id'])}}" class="px-5 py-4 " method="POST" enctype="multipart/form-data">
        @csrf
          ...
          <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
            <div>
              ...
              <div class="mt-1">
                <input
                  name="name"
                   value="{{old("name",$testimonialDBData['name'])}}"
             ...
             <div>
              ...
              <div class="mt-1">
                <input
                  name="position"
                   value="{{old("position",$testimonialDBData['position'])}}"
                  class="block w-full px-4 py-2 mt-1 border border-gray-300 rounded-md shadow-sm outline-none focus:ring-blue-400 focus:border-blue-400 sm:text-sm"
            ...
            <div>
              ...
              <div class="mt-1">
                ...
                >{{old("description",$testimonialDBData['description'])}}</textarea>
                  @error("description")
                    <small class="text-red-600">{{$message}}</small>
                @enderror
              </div>
             ...
             <div>
                 <img src="{{asset('storage/'.$testimonialDBData['photo'])}}" />
