      ...
      <div class="py-4 px-5 shadow bg-white sm:rounded-md  ">
        ...
        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
          ...
          <div>
            ...
            <div class="mt-1">
              <input name="slug" class="py-2 px-4 border outline-none shadow-sm focus:ring-blue-400 focus:border-blue-400 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" value="{{old('slug')}}" placeholder="Event Category Slug..." />
            </div>
            @error('slug')
            <div class="text-red-600 text-xs">{{ $message }}</div>
            @enderror
